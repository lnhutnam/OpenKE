...
class OctonionE(Model):
    def __init__(self, ent_tot, rel_tot, embedding_dim=200):
        ...
        self.emb_1 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_2 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_3 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_4 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_5 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_6 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_7 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.emb_8 = nn.Embedding(self.ent_tot, self.embedding_dim)
        self.rel_1 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_2 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_3 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_4 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_5 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_6 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_7 = nn.Embedding(self.rel_tot, self.embedding_dim)
        self.rel_8 = nn.Embedding(self.rel_tot, self.embedding_dim)
    ...
    def _omult(self, a_1, a_2, a_3, a_4, b_1, b_2, b_3, b_4, c_1, c_2, c_3, c_4, d_1, d_2, d_3, d_4):
        ...
        d_1_star, d_2_star, d_3_star, d_4_star = self._qstar(
            d_1, d_2, d_3, d_4)
        c_1_star, c_2_star, c_3_star, c_4_star = self._qstar(
            c_1, c_2, c_3, c_4)

        o_1, o_2, o_3, o_4 = self._qmult(
            a_1, a_2, a_3, a_4, c_1, c_2, c_3, c_4)
        o_1s, o_2s, o_3s, o_4s = self._qmult(
            d_1_star, d_2_star, d_3_star, d_4_star,  b_1, b_2, b_3, b_4)

        o_5, o_6, o_7, o_8 = self._qmult(
            d_1, d_2, d_3, d_4, a_1, a_2, a_3, a_4)
        o_5s, o_6s, o_7s, o_8s = self._qmult(
            b_1, b_2, b_3, b_4, c_1_star, c_2_star, c_3_star, c_4_star)
    ...
    def _calc(self, e_1_h, e_2_h, e_3_h, e_4_h, e_5_h, e_6_h, e_7_h, e_8_h,
        ...
        r_1, r_2, r_3, r_4, r_5, r_6, r_7, r_8 = self._onorm(
            r_1, r_2, r_3, r_4, r_5, r_6, r_7, r_8)
    ...
    def forward(self, data):
        e_1_h = self.emb_1(data['batch_h'])
        e_2_h = self.emb_2(data['batch_h'])
        e_3_h = self.emb_3(data['batch_h'])
        e_4_h = self.emb_4(data['batch_h'])
        e_5_h = self.emb_5(data['batch_h'])
        e_6_h = self.emb_6(data['batch_h'])
        e_7_h = self.emb_7(data['batch_h'])
        e_8_h = self.emb_8(data['batch_h'])

        e_1_t = self.emb_1(data['batch_t'])
        e_2_t = self.emb_2(data['batch_t'])
        e_3_t = self.emb_3(data['batch_t'])
        e_4_t = self.emb_4(data['batch_t'])
        e_5_t = self.emb_5(data['batch_t'])
        e_6_t = self.emb_6(data['batch_t'])
        e_7_t = self.emb_7(data['batch_t'])
        e_8_t = self.emb_8(data['batch_t'])

        r_1 = self.rel_1(data['batch_r'])
        r_2 = self.rel_2(data['batch_r'])
        r_3 = self.rel_3(data['batch_r'])
        r_4 = self.rel_4(data['batch_r'])
        r_5 = self.rel_5(data['batch_r'])
        r_6 = self.rel_6(data['batch_r'])
        r_7 = self.rel_7(data['batch_r'])
        r_8 = self.rel_8(data['batch_r'])
